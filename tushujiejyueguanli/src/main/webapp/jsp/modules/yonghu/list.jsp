...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //住址
            var yonghuZhuzhiCell = document.createElement('td');
            yonghuZhuzhiCell.innerHTML = item.yonghuZhuzhi;
            row.appendChild(yonghuZhuzhiCell);
            ...
            //身份
            var yonghuRoleCell = document.createElement('td');
            yonghuRoleCell.innerHTML = item.yonghuRole;
            row.appendChild(yonghuRoleCell);


            //专业
            var yonghuZhanyeCell = document.createElement('td');
            yonghuZhanyeCell.innerHTML = item.yonghuZhanye;
            row.appendChild(yonghuZhanyeCell);
