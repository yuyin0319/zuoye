            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">借阅记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="tushuId" name="tushuId" v-model="ruleForm.tushuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>最晚还书时间</label>
                                        <input id="huanshuTime" name="huanshuTime" class="form-control"
                                               v-model="ruleForm.huanshuTime" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>借阅状态</label>
                                    <input id="jieyueValue" name="jieyueValue" class="form-control"
                                           v-model="ruleForm.jieyueValue" readonly>
                                </div>
