            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑虚拟书架</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    // 获取当前详情
    function getDetails() {
        var addshujia = window.sessionStorage.getItem("addshujia");
        if (addshujia != null && addshujia != "" && addshujia != "null") {
            window.sessionStorage.removeItem('addshujia');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("shujia/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
